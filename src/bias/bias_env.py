...
class BiasObservation(Language_Observation):
...
class BiasEnvironment(Language_Environment):
    ...
    def step(self, action: str) -> Tuple[BiasObservation, float, bool]:
        if self.stepped:
    ...
    def reset(self) -> BiasObservation:
        ...
        return BiasObservation(self.parent, None, None)
