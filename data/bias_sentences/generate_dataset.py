...
def load_dataset(dataset_name = "data/bias_sentences/stereoset.csv"):
    ...
    dataset = dataset[dataset["q_value"] != -2]
    print("Dataset shape:", dataset.shape)
    ...
    with open('data/bias_sentences/train_idxs.json', 'w') as f:
        json.dump(train_idxs, f)
    
    with open('data/bias_sentences/test_idxs.json', 'w') as f:
        json.dump(test_idxs, f)
    
    with open('data/bias_sentences/eval_idxs.json', 'w') as f:
