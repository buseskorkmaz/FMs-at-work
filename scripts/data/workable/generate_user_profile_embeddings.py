...
def main():
    ...
    # load dataset
    user_profile_dataset = load_dataset("json", data_files='/dccstor/autofair/bias_llm/Bias-ILQL/data/workable/unique_candidate_database.json', split="train[:10%]")
