...
@dataclass
class CFG:
    dist_checkpoint_root_folder:str = "/gpfs/home/bsk18/FMs-at-work/outputs/llama/checkpoints"
...
def train(cfg):
    ...
    # save_config = CFG()
    # save_config.dist_checkpoint_root_folder = os.path.join(train_cfg['save_checkpoint_dir'])
